...
const submit = async () => {
    ...
    const url = process.env.VITE_FORM_ENDPOINT
...
<div class="center">
    <form class="vue-form" @submit.prevent="submit">
        ...
        <div v-if="emailValid === false" class="error-message">
        ...
        <div>
            ...
            <input type="email" name="email" id="email" required=""
                :class="{ email , error: emailValid === false }"
                v-model="email">
        </div>
        ...
        <div>
            <h4>Topic</h4>
            <p class="select">
            <select class="budget" v-model="topic">
